# Generated by Django 4.0 on 2025-11-13 01:40
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('comment', models.TextField(verbose_name='記事')),
                ...
                ('category', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='test2_app.category', verbose_name='カテゴリ')),
